							...
							<div class="row" style="margin-bottom:40px">
								<div class="col-xs-8">
									...
									<div class="form-group" >
					                    ...
					                    <img id="avatar" class="thumbnail" width="300px" src="img/ok.jpg">
									</div>
									<div class="form-group" >
									...
									<div class="form-group" >
										...
										<input required type="text" name="phukien" class="form-control" value="Bình xịt Clear giày">
									</div>
									<div class="form-group" >
									...
									<div class="form-group" >
										...
										<input required type="text" name="tinhtrang" class="form-control" value=" Chính Hãng">
									</div>
									<div class="form-group" >
										<label>Miêu tả</label>
